...
import SettingsSmartProductTagEditPageV4Img from './SettingsSmartProductTagEditPageV4Img.tsx'


// Component

        function SmartProductTagEditLayoutV4Img() {
            return (
                <body className={""}>
                    <iframe
                        ...
                        <div className={"d-flex"}>
                            ...
                            <div className={"brand-page-wrap-content brand-page-wrap-content-margin-left"}>
                                ...
                                <div className={"brand-wrapper-fluid container-fluid smart_product_tag_edit"}>
                                    <SettingsSmartProductTagEditPageV4Img />
                                </div>
...
export default SmartProductTagEditLayoutV4Img
