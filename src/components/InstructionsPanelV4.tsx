...
// Component
        ...
        function InstructionsPanelV4({ onModify }: { onModify?: () => void }) {
            return (
                <div data-v-716c1e5e={""} className={"instructions-panel"} onChange={onModify}>
                    <div data-v-716c1e5e={""} className={"panel-header"}>
                        <div data-v-716c1e5e={""} className={"d-flex justify-content-between align-items-start"} style={{ marginBottom: "16px" }}>
                            <div data-v-716c1e5e={""}>
                                <div data-v-716c1e5e={""} className={"panel-title"}>
                                    Utasítások
                                </div>
                                <div data-v-716c1e5e={""} className={"panel-subtitle"} style={{ marginTop: "8px" }}>
                                    Változók: headline4, subHeadline4
                                </div>
                            </div>
                            <div data-v-4811c2cf={""} data-v-716c1e5e={""} className={"chip chip-sm design-system chip-gray"}>
...
export default InstructionsPanelV4
