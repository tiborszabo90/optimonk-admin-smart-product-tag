            ...
            return (
                <div data-v-b06cb0a2={""} data-v-716c1e5e={""} className={"save-dropdown-wrapper"}>
                    <PrimaryButton
                        ...
                        label="Mentés"
                        navigateRoutes={JSON.stringify(["/v4/53722/settings/smart-product-tag-edit/699edcbfdb8587b4c75fa42f?step=2", "/v4/53722/settings/smart-product-tag-edit/699edcbfdb8587b4c75fa42f?step=3"])}
                        showChevron={true}
                    />
                    {isOpen && (
