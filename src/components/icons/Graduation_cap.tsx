...
export const Graduation_cap = () => {
    return (
<svg data-v-716c1e5e={""} width={"20px"} height={"20px"} xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 24 24"} fill={"currentColor"} className={"ui-svg-inline"}>
