...
export const Play_button_circle = () => {
    return (
<svg width={"1.5rem"} height={"1.5rem"} xmlns={"http://www.w3.org/2000/svg"} viewBox={"0 0 24 24"} fill={"currentColor"} color={"#505763"} className={"ui-svg-inline mx-3"}>
...
export default Play_button_circle
