...
import SettingsSmartProductTagEditPageV4 from './SettingsSmartProductTagEditPageV4.tsx'


// Component

        function SmartProductTagEditLayoutV4() {
            return (
                <body className={""}>
                    <iframe
                        ...
                        <div className={"d-flex"}>
                            ...
                            <div className={"brand-page-wrap-content brand-page-wrap-content-margin-left"}>
                                ...
                                <div className={"brand-wrapper-fluid container-fluid smart_product_tag_edit"}>
                                    <SettingsSmartProductTagEditPageV4 />
                                </div>
...
export default SmartProductTagEditLayoutV4
