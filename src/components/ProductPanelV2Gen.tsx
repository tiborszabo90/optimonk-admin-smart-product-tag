        ...
        function ProductPanelV2Gen({
            ...
            return (
                <div data-v-716c1e5e={""} className={"panel-content preview-content"} style={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <Paginator page={page} totalPages={totalPages} total={previews.length} onPage={setPage} />
                </div>
            );
        }
...
// Subcomponents
        ...
        function Paginator({
            ...
            const btnStyle = (disabled: boolean, active = false): React.CSSProperties => ({
                ...
                borderRadius: '4px',
                border: 'none',
                background: active ? 'rgba(185,190,198,0.4)' : 'transparent',
                cursor: disabled ? 'default' : 'pointer',
                color: disabled ? '#d5d8dd' : '#505763',
                fontSize: '14px',
                fontWeight: 500,
                margin: '0 2px',
            });
            ...
            return (
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '12px', fontSize: '14px', color: '#505763' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                        <button style={btnStyle(page === 1)} disabled={page === 1} onClick={() => onPage(page - 1)}>
                        ...
                        <button style={btnStyle(page === totalPages)} disabled={page === totalPages} onClick={() => onPage(page + 1)}>
...
export default ProductPanelV2Gen
