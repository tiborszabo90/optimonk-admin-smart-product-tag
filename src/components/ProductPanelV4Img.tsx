            ...
            return (
                ...
                >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        {!generated && <div style={{ width: '56px', height: '56px', borderRadius: '6px', flexShrink: 0, background: '#e3e5e8' }} />}
                    ...
                    {generated && (
                        <>
                            ...
                            <div style={{ display: 'flex', gap: '8px' }}>
                                <div style={{ flex: 1, aspectRatio: '1 / 1', borderRadius: '6px', background: '#e3e5e8' }} />
                                <div style={{ flex: 1, aspectRatio: '1 / 1', borderRadius: '6px', background: '#e3e5e8' }} />
                            </div>
                        </>
                    )}
...
export default ProductPanelV4Img
