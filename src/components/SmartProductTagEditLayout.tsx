...
import SettingsSmartProductTagEditPage from './SettingsSmartProductTagEditPage.tsx'


// Component

        function SmartProductTagEditLayout() {
            return (
                <body className={""}>
                    <iframe
                        ...
                        <div className={"d-flex"}>
                            ...
                            <div className={"brand-page-wrap-content brand-page-wrap-content-margin-left"}>
                                ...
                                <div className={"brand-wrapper-fluid container-fluid smart_product_tag_edit"}>
                                    <SettingsSmartProductTagEditPage />
                                </div>
...
export default SmartProductTagEditLayout
