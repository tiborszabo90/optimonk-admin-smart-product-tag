...
import SettingsSmartProductTagEditPageV2Gen from './SettingsSmartProductTagEditPageV2Gen.tsx'


// Component

        function SmartProductTagEditLayoutV2Gen() {
            return (
                <body className={""}>
                    <iframe
                        ...
                        <div className={"d-flex"}>
                            ...
                            <div className={"brand-page-wrap-content brand-page-wrap-content-margin-left"}>
                                ...
                                <div className={"brand-wrapper-fluid container-fluid smart_product_tag_edit"}>
                                    <SettingsSmartProductTagEditPageV2Gen />
                                </div>
...
export default SmartProductTagEditLayoutV2Gen
